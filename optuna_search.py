...
# 手动设置超参数
args.num_recon_nodes = 1  # 可以设置为 1 或 3
args.num_it_recon = 300
args.beta = 0.05  # 可以设置为 0.01 到 0.1 之间的值
args.decay = 0.5  # 可以设置为 0 到 1 之间的值
...
if __name__ == "__main__":   
    ...
    print('    num_recon_nodes: {}'.format(args.num_recon_nodes))
    print('    num_it_recon: {}'.format(args.num_it_recon))
